...
inline int Settings::citizen_ini_life(CitizenType ct) const
{
  ...
  {
  case Builder:
    return builder_ini_life();
    break;
  case Warrior:
    return warrior_ini_life();
    break;
  default:
    return -1;
  }
...
inline int Settings::weapon_strength_attack(WeaponType w) const
{
  ...
  {
  case Hammer:
    return hammer_strength_attack();
    break;
  case Gun:
    return gun_strength_attack();
    break;
  case Bazooka:
    return bazooka_strength_attack();
    break;
  case NoWeapon:
    return builder_strength_attack();
    break;
  default:
    return -1;
  }
...
inline int Settings::weapon_strength_demolish(WeaponType w) const
{
  ...
  {
  case Hammer:
    return hammer_strength_demolish();
    break;
  case Gun:
    return gun_strength_demolish();
    break;
  case Bazooka:
    return bazooka_strength_demolish();
    break;
  case NoWeapon:
    return builder_strength_demolish();
    break;
  default:
    return -1;
  }
...
inline int Settings::num_rounds_regen_citizen(CitizenType ci) const
{
  ...
  {
  case Builder:
    return num_rounds_regen_builder();
    break;
  case Warrior:
    return num_rounds_regen_warrior();
    break;
  default:
    return -1;
  }
...
inline bool Settings::ok() const
{
  ...
  if (builder_strength_demolish() > hammer_strength_demolish())
    return false;
  if (hammer_strength_demolish() > gun_strength_demolish())
    return false;
  if (gun_strength_demolish() > bazooka_strength_demolish())
    return false;

  if (builder_strength_attack() > hammer_strength_attack())
    return false;
  if (hammer_strength_attack() > gun_strength_attack())
    return false;
  if (gun_strength_attack() > bazooka_strength_attack())
    return false;

  if (barricade_resistance_step() > barricade_max_resistance())
    return false;
